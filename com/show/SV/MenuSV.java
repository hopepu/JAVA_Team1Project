...
public class MenuSV { // 모든 메뉴 모음
	...
	public static void mainMenu(Scanner s, Scanner sL, MemberDTO loginState, ArrayList<MemberDTO> loginDTOs,ArrayList<ReviewDTO> reviewDTOs , ArrayList<ShowDTO> showDTOs , ArrayList<DramaDTO> dramaDTOs, ArrayList<VarietyDTO> varietyDTOs) {
		...
		while (run) {
			...
			case 1:
				...
				break;
			case 2:
				loginMenu(s, loginState, loginDTOs, reviewDTOs, showDTOs, dramaDTOs, varietyDTOs, sL);
				break;
			case 3:
	...
	/*2-1. 로그인 메뉴 */
	public static void loginMenu(Scanner s,MemberDTO loginState, ArrayList<MemberDTO> loginDTOs,ArrayList<ReviewDTO> reviewDTOs , ArrayList<ShowDTO> showDTOs , ArrayList<DramaDTO> dramaDTOs, ArrayList<VarietyDTO> varietyDTOs,Scanner sL) {
		boolean run = true;
		while(run) {
			...
			case 1:
				...
				if(loginState.isLoginStatus()) {//로그인 성공했다면
					userMainMenu(s, sL, loginState, loginDTOs, reviewDTOs, showDTOs, dramaDTOs, varietyDTOs);
				}//user 메뉴로 전송
				break;
			case 2:
